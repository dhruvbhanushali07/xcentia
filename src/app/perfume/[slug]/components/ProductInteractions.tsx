...
export default function ProductInteractions({
  ...
  // Ensure component is mounted before allowing interactions (for hydration consistency)
  useEffect(() => {
	setMounted(true);
  }, []);
		...
		<div className="mt-10">
			...
			<div className="flex items-center justify-between mb-6">
				...
				<div className="flex items-center gap-0 border border-black/15">
					...
					<span
						className="w-10 h-10 flex items-center justify-center text-[13px] font-semibold
